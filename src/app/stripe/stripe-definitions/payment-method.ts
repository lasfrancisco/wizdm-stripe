...
export interface PaymentMethodData {
  ...
  /**
   * An idealBank Element or an object with the customer's bank.
   */
  ideal?: Element<'ideal'> | { bank: string };

  /**
   * An iban Element or an object with an IBAN account number.
   */
  sepa_debit?: Element<'iban'> | { iban: string };
