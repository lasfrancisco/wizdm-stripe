...
export interface PaymentRequest {
   ...
   */
  update(options: PaymentUpdateOptions): void;
...
export interface NewShippingAddress {
   ...
   */
  updateWith: (dataToUpdate: PaymentUpdateOptions) => void;
 ...
 * @see https://stripe.com/docs/stripe-js/reference#payment-request-update
 */
export interface PaymentUpdateOptions {
  /**
 ...
 */
export interface PaymentRequestOptions extends PaymentUpdateOptions {
  /**
...
export interface PaymentItem {
   ...
   * @see StripePaymentRequestOptions.currency
   */
  amount: number;
...
export interface PaymentResponse {
   ...
   * NOTE: This is only set if the corresponding field was set to `true` in the `PaymentRequestOptions`
   * @see PaymentRequestOptions.requestPayerName
   * @see PaymentRequestOptions.requestPayerEmail
   * @see PaymentRequestOptions.requestPayerPhone
   */
